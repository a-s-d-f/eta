		...
		<div class="row">
			<ul class="nav nav-pills nav-stacked">
				<ul class="nav nav-pills nav-stacked">
					...
					<li class="active"><a href="wine">ワイン編集</a></li>
			...
			<tbody>
				<?php foreach($datas['wine'] as $row):?>
					<tr>
						...
						<td><a href=<?php echo Config::get('WINE_IMG_PATH') . $row["imgurl"];?> rel="lightbox-wines" class="btn btn-lg btn-primary" title=<?php echo $row["name"];?>>表示</a></td>
