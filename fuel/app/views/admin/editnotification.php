			...
			<form action="confirm" method="post">
				<table class="table">
					...
					<tbody id="target">
						...
						<tr>
							<td><input class="input-lg form-control" type="text" name="title[]" value=<?php echo $val["title"];?>></td>
							<td><textarea style="resize:vertical" class="form-control" name="body[]"><?php echo $val["body"];?></textarea></td>
						</tr>
