		...
		<div class="row">
			<ul class="nav nav-pills nav-stacked">
				<ul class="nav nav-pills nav-stacked">
					...
					<li class="active"><a href="menu">メニュー編集</a></li>
			...
			<tbody>
				<?php foreach($datas['menu'] as $row):?>
					<tr>
						...
						<td><a href=<?php echo Config::get('MENU_IMG_PATH') . $row["imgurl"];?> rel="lightbox-menus" class="btn btn-lg btn-primary" title=<?php echo $row["name"];?>>表示</a></td>
